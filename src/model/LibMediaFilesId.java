...
/**
 * LibMediaFilesId entity. @author MyEclipse Persistence Tools
 */

public class LibMediaFilesId implements java.io.Serializable {
	...
	/** default constructor */
	public LibMediaFilesId() {
	}

	/** full constructor */
	public LibMediaFilesId(String idRef, String filePath, String fileType) {
		this.idRef = idRef;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof LibMediaFilesId))
			return false;
		LibMediaFilesId castOther = (LibMediaFilesId) other;
