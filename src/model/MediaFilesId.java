...
/**
 * MediaFilesId entity. @author MyEclipse Persistence Tools
 */

public class MediaFilesId implements java.io.Serializable {
	...
	/** full constructor */
	public MediaFilesId(String idRef, String filePath, String fileType) {
		this.idRef = idRef;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MediaFilesId))
			return false;
		MediaFilesId castOther = (MediaFilesId) other;
