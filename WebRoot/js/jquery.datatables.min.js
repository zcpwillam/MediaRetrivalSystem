...
e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"首页",sLast:"末页",sNext:"下一页",sPrevious:"上一页"},sEmptyTable:"表中无数据",sInfo:"显示 _START_ 到 _END_ 条/共 _TOTAL_ 条",
sInfoEmpty:"显示 0 到 0 条/共 0 条",sInfoFiltered:"(从 _MAX_ 条记录中筛选)",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"显示 _MENU_ 条记录",sLoadingRecords:"载入中...",sProcessing:"处理中...",sSearch:"搜索:",sUrl:"",sZeroRecords:"无匹配记录"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET"};
